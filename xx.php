...
<div class="container">
			...
			<td>
		     ...
		     <td colspan="2">
					<form method="POST" action="">
						...
						<input type="number" name="quantity" class="form-control input-quantity" value="<?php echo $_SESSION['cart'][$i]?>" min="1">
					</form>
			</td>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<a href="../controllers/return_asset.php?id=<?php echo $i ?>" class="btn btn-success">Confirm</a>
								</div>
							</div>
						</div>
					</div>
	...
	<?php else: ?>
		<h2 class="py-4">Your don't have any request yet</h2>
